    ...
    <form action="{{ route('transcation.post') }}" class="max-w-md mx-auto" enctype="multipart/form-data" method="POST">
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <label for="duration"
                ...
                Contoh: 1</label>
            <button onclick="getValue()">Check Harga</button>
        </div>
        ...
        <div class="relative z-0 w-full mb-5 group"> {{-- Menampilkan Total Pembayaran --}}
            ...
            <label for="total_harga" id="displayArea"
                class="peer-focus:font-medium absolute text-sm text-gray-900 dark:text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Silahkan Click Tombol "Check Harga"</label> 
        </div>
        <div class="relative z-0 w-full mb-5 group">
