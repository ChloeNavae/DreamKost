                    ...
                    <li>
                        <a href="/dbpengumuman"
                            ...
                            <svg class="flex-shrink-0 w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white"
                                ...
                                viewBox="0 0 20 18">
                                <path
                                    d="M12 2a6 6 0 0 0-6 6c0 3.09-1.11 5.71-3 7h18c-1.89-1.29-3-3.91-3-7a6 6 0 0 0-6-6ZM9 20a3 3 0 0 0 6 0H9Z" />
                            </svg>
                    ...
                    <li>
                        <a href="/dbkomplain"
                            ...
                            <svg class="flex-shrink-0 w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white"
                                ...
                                viewBox="0 0 18 18">
                                <path
                                    d="M18 10c0 3.866-3.582 7-8 7a9.06 9.06 0 0 1-2.85-.453c-.795.659-2.156 1.453-3.984 1.44a.5.5 0 0 1-.39-.812c.407-.502.812-1.114 1.076-1.813C2.716 13.795 2 12 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7ZM10 6a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0V7a1 1 0 0 1 1-1Zm0 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" />
                            </svg>
                            <span class="flex-1 ms-3 whitespace-nowrap">Komplain Penghuni</span>
                            <span id="badge-pending-komplain" class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium  rounded-full bg-blue-900 text-blue-300">0</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dbtransaksi"
